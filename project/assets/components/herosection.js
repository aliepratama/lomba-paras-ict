class HeroSection extends HTMLElement {
    ...
    _render(){
        this.innerHTML = `
            <div class="flex justify-between items-center px-3 lg:px-24 py-16">
                <div class="flex flex-col gap-y-6 lg:gap-y-12">
                    <div class="flex flex-col gap-y-4 lg:gap-y-6 items-center lg:items-start">
                        <h1 class="heading1">
                            ...
                            <span class="text-primary">literasi membaca.</span>
                        </h1>
                    ...
                    <div class="flex gap-x-2 lg:gap-x-7 w-full justify-between">
                        <div class="w-full flex items-center justify-center input-text-rg px-4 py-3 lg:py-5 lg:px-6 gap-x-4">
                            <input class="w-full regular-text text-left text-lblack prevent-input-text" type="text" placeholder="Contoh: Laskar Pelangi">
                            <i class="fa fa-search regular-text text-left text-lblack"></i>
                        </div>
                        <button class="flex button-fill-rg regular-text text-left px-4 py-3 lg:p-5 gap-x-4 items-center">
